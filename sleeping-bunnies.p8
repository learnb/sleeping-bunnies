...
function init_sim()
  ...
  fox.patrol_points = patroltiles()
  fox.target = fox.patrol_points[1]
  fox.patrol_indx = 1
  fox.x = (fox.target.x-1) * 8
  fox.y = (fox.target.y-1) * 8
...
function update_sim()
  if (not rabbit.hidden) then
    lastknownposition = ent_tile(rabbit)
  end
...
function draw_sim()
  ...
  if (rabbit.sniff) then
    ...
    -- draw rabbit info
    circ((lastknownposition.x-1)*8, (lastknownposition.y-1)*8, 1, 10)
    circ((lastknownposition.x-1)*8, (lastknownposition.y-1)*8, 3, 9)
    circ((lastknownposition.x-1)*8, (lastknownposition.y-1)*8, 5, 10)
  end
...
function patroltiles()
  local _list = {}
  for _y=0,15 do -- rows
    for _x=0,15 do -- cols
      if (fget(mget(_x,_y),2)) then
        local t = {}
        t.x = _x+1
        t.y = _y+1
        add(_list, t)
...
function draw_ui()
  ...
  if (rabbit.hp > 0) then
    rectfill(51,123, (51+(rabbit.hp/10)),124, 11)
  end
  -- sniff ability
  local sp = 0
  print("sp", 16,121, 1)
  ...
  if (not sniff_lock) then -- duration
    ...
    rectfill(26,123, 26+(sp),124, 12)
  elseif (sniff_lock) then -- cooldown
    sp = 10*(sniff_tick/sniff_cooldown)
    rectfill(26+(sp),124, 26,123, 8)
  end
  -- gamepad
  --draw_gamepad(66, 120)
  --draw_gamepad(32-4, 120-8)
  draw_gamepad(0, 112)
  -- separators
  ...
  for i=1,16 do
    for j=1,16 do
      ...
      elseif (_right < _left) then
        _x = 1
        _x_min = _right
      --elseif (_c == _x_min) then -- left & right equal
      --  if (rnd(1) > 0.5) then -- randomly choose
      --    _x = -1
      --  else
      --    _x = 1
      --  end
      ...
      elseif (_bottom < _top) then
        _y = 1
      --elseif (_c == _y_min) then -- top & bottom equal
      --  if (rnd(1) > 0.5) then -- randomly choose
      --    _y = -1
      --  else
      --    _y = 1
...
function path_print_field()
  for i=1,16 do
    for j=1,16 do
      ...
      line(_x, _y, _x+(2*_vec.x), _y+(2*_vec.y), 8)
      line(_x, _y, _x, _y, 6)
    end
  end
end
...

...

...

__gff__

__map__

